...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-bioformats-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13345&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-bioformats-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-bioformats` can be installed with:

```
conda install napari-bioformats
```

It is possible to list all of the versions of `napari-bioformats` available on your platform with:
